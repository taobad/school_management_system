...
class educare_event_calendar {
  ...
  public function displayCalendar() {
    ...
    $calendar .= '<a class="prev-month change-event" href="?page=educare-about-us&month=' . $prevMonth . '&year=' . $prevYear . '" data="month=' . $prevMonth . '&year=' . $prevYear . '"><span class="dashicons dashicons-arrow-left-alt2"></span></a> ';
    $calendar .= $monthYear . ' ';
    $calendar .= '<a class="next-month change-event" href="?page=educare-about-us&month=' . $nextMonth . '&year=' . $nextYear . '" data="month=' . $prevMonth . '&year=' . $prevYear . '"><span class="dashicons dashicons-arrow-right-alt2"></span></a>';
    $calendar .= '</caption>';
		// Go Next Month
