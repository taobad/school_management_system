...
function educare_add_default_settings($list, $show_data = null, $new_data = null) {
	...
	if ($list == 'Settings') {
		...
		$target = array(
			...
			'banner' => [
				'title' => 'Institutions Name Or Slogan',
				'subtitle1' => 'Rangpur, Dhaka, Bangladesh',
				'subtitle2' => 'Founded in '. date('Y'),
				'logo1' => EDUCARE_URL . 'assets/img/card-logo1.svg',
				'logo2' => EDUCARE_URL . 'assets/img/card-logo2.svg',
				// 'status' => 'checked'
			],
			'grade_system' => [
				'current' => 'Default',
