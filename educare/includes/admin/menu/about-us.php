...
<div class="educare_post">
  <div class="educare_post_content about">
    ...
    <h4 style="font-size: 22px; line-height: 1.4">Educare is a powerful online School, College, students & results management system dev by <a href="http://fixbd.net" target="_blank"><img src="<?php echo esc_url(EDUCARE_URL . 'assets/img/fixbd.svg'); ?>" width="50px" alt="fixbd" /></a>. This plugin allows you to manage and publish students results. This is a school, college, students & results management plugin that was created to easily manage institute, academy or student results at online.</h4>

    <p>Educare help you to easily control over your institute students at online. You can easily Add/Edit/Delete Teachers, Students, Results, Class, Group, Exam, Rating Scale, Year, Extra Field, Custom Result Rules, Auto result calculations and much more… Also you can add marks, promote or import & export unlimited students and results just one click!</p>
    ...
    <div class="select">
      ...
      <div>
        <h4>Our Vision</h4>
        <p>We are committed to adjust your results system with Educare. Because, we believe in freedom and understand the value of your project. So, get in touch and help us deliver your project!</p>
      </div>
    </div>
